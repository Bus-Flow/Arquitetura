...
output "lambda_ingestion_gtfs_function_name" {
  value = aws_lambda_function.ingestion_gtfs.function_name
}

output "lambda_ingestion_gtfs_function_arn" {
  value = aws_lambda_function.ingestion_gtfs.arn
}
