...
output "lambda_ingestion_arn" {
  description = "Lambda Ingestion ARN (Tempo Real)"
  value       = module.lambda.lambda_ingestion_function_arn
}

output "lambda_ingestion_gtfs_arn" {
  description = "Lambda Ingestion GTFS ARN"
  value       = module.lambda.lambda_ingestion_gtfs_function_arn
}
